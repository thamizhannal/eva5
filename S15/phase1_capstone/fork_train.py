...
#from encoder_decoder_arch import *
from model import *
...
def train():
    ...
    # Initialize model
    # TODO custom code to experiment.
    ...
    model.load_state_dict(torch.load('/content/gdrive/My Drive/SchoolOfAI_EVA/YoloV3_S13/YoloV3/weights/best.pt')['model'])
    ...
    #TODO Specify the location of the YoloV3 image directory in gdrive.

    os.chdir('/content/gdrive/My Drive/SchoolOfAI_EVA/YoloV3_S13/YoloV3')
    #os.chdir('C:\\Users\\tparamas\\PycharmProjects\\YoloV3')
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            depth_images = '/content/gdrive/My Drive/SchoolOfAI_EVA/YoloV3_S13/YoloV3/data/customdata/midas_out_colormap'
            #depth_images = 'C:\\Users\\tparamas\\PycharmProjects\\MiDaS-master\\midas_out_colormap'
            #
            from util_depth import _get_depth_targets

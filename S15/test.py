...
def test(cfg,
    ...
    for batch_i, (imgs, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            depth_targets = _get_depth_targets(paths=paths, loc='/content/gdrive/My Drive/SchoolOfAI_EVA/YoloV3_S13/YoloV3/data/customdata/midas_out_colormap').to(device)
            ssim_loss = SSIM()
